...
<div class="col-lg-12">
<h1 class="page-header mb-2 font-weight-bold text-gray-800" style="margin-top:20px; color:#212121;">작성 페이지</h1>
</div>
</div>
...
<form role="form" action="/ks/freewrite" method="post" onsubmit="return _onSubmit();" enctype="multipart/form-data">
...
<div align="center">
	...
	<a href="/ks/freeboard" class="btn btn-warning">취소</a>
</div>
</form>
</div>
</div>
