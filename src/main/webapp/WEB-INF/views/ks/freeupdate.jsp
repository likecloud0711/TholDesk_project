...
<div class="col-lg-12">
<h1 class="page-header">자유게시판 작성 페이지</h1>
</div>
</div>
...
<form action="/ks/freeupdate" method="post" >
	...
	<tbody>
		...
		<tr>	
			...
			<td class="form-inline">
				<input type="file" value="freeupload">
		</tr>
...
<a href="/ks/freeboard" class="btn btn-danger">취소</a>
</div>
</form>
</div>
</div>
