...
<div class="col-lg-12">
<h1 class="page-header">부서게시판 작성 페이지</h1>
</div>
</div>
...
<form action="/ks/teamupdate" method="post" >
	...
	<tbody>
		...
		<tr>	
			...
			<td class="form-inline">
				<input type="file" value="teamupload">
		</tr>
...
<a href="/ks/teamboard" class="btn btn-danger">취소</a>
</div>
</form>
</div>
</div>
