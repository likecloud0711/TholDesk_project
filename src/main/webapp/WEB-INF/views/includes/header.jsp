...
<body id="page-top">
  ...
  <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v1H1V2a1 1 0 0 1 1-1h12zm1 3v10a1 1 0 0 1-1 1h-2V4h3zm-4 0v11H2a1 1 0 0 1-1-1V4h10z"/>
            ...
            <!-- Chat -->
            <li class="nav-item active">
                <a class="nav-link collapsed text-center" href="/chat.html"  data-target="#collapseChat"
            ...
            <!-- AttendCheck : 근태 -->
                  <li class="nav-item active">
                <a class="nav-link collapsed text-center" href="../work/insertView"  data-target="#collapseCheck"
