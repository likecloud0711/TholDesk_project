...
pageEncoding="UTF-8"%> <!-- jsp 에는 이 차셋을 써야함. -->
...
<head>
    ...
    <!-- 애플의 safari(사파리) 브라우저에만 영향을 미치는 속성 viewport의 크기보다 내용이 크면, 내용을 줄여서 보여주는데 그걸 막음. -->
    <!-- width=device-width는 웹 페이지의 크기가 모니터와 스마트폰의 실제 액정 크기를 따라가도록 한다 -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #000080;" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
              ...
              <div class="sidebar-brand-text mx-3">TD Group</div>
            </a>
            ...
            <!-- 전자결재 -->
                ...
                <a class="nav-link collapsed text-center" href="#" data-toggle="collapse" data-target="#collapseEapp"
                    aria-expanded="true" aria-controls="collapseEapp">

                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-layout-text-window" viewBox="0 0 16 16">
  ...
  <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v1H1V2a1 1 0 0 1 1-1h12zm1 3v10a1 1 0 0 1-1 1h-2V4h3zm-4 0v11H2a1 1 0 0 1-1-1V4h10z"/>
				...
				<div id="collapseEapp" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header" align="center">Approval</h6>
                        <a class="collapse-item" align="center" href="/Eapp/eapproval">목록</a>
                        <a class="collapse-item" align="center" href="/Eapp/signlist">결재처리</a>
                        <a class="collapse-item" align="center" href="/Eapp/permission">승인</a>
                        <div class="collapse-divider"></div>
                        <a class="collapse-item" align="center" href="/Eapp/waiting">대기</a>
                        <a class="collapse-item" align="center" href="/Eapp/reject">반려</a>
                        <a class="collapse-item" align="center" href="/Eapp/outboxpage">임시보관함</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Chat -->
            <li class="nav-item active">
                <a class="nav-link collapsed text-center" href="/chat.html" data-toggle="collapse" data-target="#collapseChat"
            ...
            <!-- AttendCheck : 근태 -->
                  <li class="nav-item active">
                <a class="nav-link collapsed text-center" href="#" data-toggle="collapse" data-target="#collapseCheck"
            ...
            <!-- Organization chart : 조직도 -->
                  <li class="nav-item active">
                <a class="nav-link collapsed text-center" href="#" data-toggle="collapse" data-target="#collapseChart"
            ...
            <!-- Calendar -->
                  <li class="nav-item active">
                <a class="nav-link collapsed text-center" href="" data-toggle="collapse" data-target="#collapseCalendar"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-calendar-week" viewBox="0 0 16 16">
            	...
            	<div id="collapseCalendar" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">CALENDAR</h6>
                        <a class="collapse-item" href="/Calendar/CldMain">calendar</a>
                    </div>
                </div>
            </li>
        </ul>
